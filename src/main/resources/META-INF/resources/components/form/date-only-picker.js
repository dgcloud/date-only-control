...
/**
 * DateOnlyPicker component.
 * 
 * @namespace Alfresco
 * @class Alfresco.DateOnlyPicker
 */
(function()
{
   /**
   ...
   /**
    * DateOnlyPicker constructor.
    * 
    * @param {String} htmlId The HTML id of the parent element
    * @param {String} currentValueHtmlId The HTML id of the parent element
    * @return {Alfresco.DateOnlyPicker} The new DateOnlyPicker instance
    * @constructor
    */
   Alfresco.DateOnlyPicker = function(htmlId, currentValueHtmlId)
   {
      // Mandatory properties
      this.name = "Alfresco.DateOnlyPicker";
      this.id = htmlId;
   ...
   Alfresco.DateOnlyPicker.prototype =
   {
      /**
       ...
       * @return {Alfresco.DateOnlyPicker} returns 'this' for method chaining
       */
      setOptions: function DateOnlyPicker_setOptions(obj)
      {
       ...
       * @return {Alfresco.DateOnlyPicker} returns 'this' for method chaining
       */
      setMessages: function DateOnlyPicker_setMessages(obj)
      {
       ...
       */
      onComponentsLoaded: function DateOnlyPicker_onComponentsLoaded()
      {
       ...
       * @method onReady
       */
      onReady: function DateOnlyPicker_onReady()
      {
         var theDate = null;
       ...
       * @private
       */
      _showPicker: function DateOnlyPicker__showPicker(event)
      {
       ...
       * @private
       */
      _handlePickerChange: function DateOnlyPicker__handlePickerChange(type, args, obj)
      {
         ...
         if (selDate != null)
         {
            ...
            if (this.options.submitTime)
            {
               ...
               isoValue = isoValue.substr(0, isoValue.indexOf("T") + 1) + this.options.fixedTime;
            }
            else
            {
       ...
       * @private
       */
      _handleFieldChange: function DateOnlyPicker__handleFieldChange(event)
      {
       ...
       * @private
       */
      _msg: function DateOnlyPicker__msg(messageId)
      {
         return Alfresco.util.message.call(this, messageId, "Alfresco.DateOnlyPicker", Array.prototype.slice.call(arguments).slice(1));
      }
   };
})();
